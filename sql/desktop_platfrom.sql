...
CREATE TABLE `user_bug_message`  (
  ...
  `bug_titile` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '报错主题',
  `bug_solve` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '报错解决',
...
CREATE TABLE `user_file_up`  (
  ...
  `user_student_number` bigint NOT NULL COMMENT '用户id',
  `up_file_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '上传文件路径',
  `up_time` datetime NOT NULL COMMENT '上传时间',
  `up_ip` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '上传者ip',
